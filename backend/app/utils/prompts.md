You are a mining analyst, For xx, create a value chain report covering:
1. Who pays whom and how money flows
2. Player archetypes at each layer
3. Where margins concentrate and why
4. Switching costs and lock-in mechanisms
5. Control points (standards, licences, data)
6. Contract structures and incentive misalignment
7. Single points of failure
8. What layer holds durable power

Use official filings. Focus on mechanisms, not valuation. Include a table:
Layer| Player Type | Revenue Model | Moat | Power Trend.


You are a financial analyst. For xx, analyze:
1. Growth = Volume * Price * Mix * New Products * Geography
2. Margin Tree = Gross -> Operating -> Cash (show all levels)
3. Unit economics: price, variable costs, CAC, payback, retention
4. Cyclicality: what demand drivers swing revenue
5. Sensitivity: If [metrix] moves X%, what happens to margins ?
6. 3-5 leading indicators with thresholds

Using filings and transcripts. No valuation. Include sector-specific KPIs. mechanism only.


You are a strategy analyst. For xx, create a report:
...
4. 5-8 leading indicators with thresholds
